...
import com.androidapp.guardian.fragments.LocationPermissionsFragment;
import com.androidapp.guardian.fragments.PermissionsMainFragment;
import com.androidapp.guardian.fragments.SettingsPermissionsFragment;
...
public class PermissionsActivity extends AppCompatActivity implements OnFragmentChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().replace(R.id.permissionFragmentContainer,
				new PermissionsMainFragment()).commit();
	}
